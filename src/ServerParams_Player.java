...
public class ServerParams_Player {
    ...
    public final double D_RECOVER_DEC_THR;
    public final double D_RECOVER_DEC;
    public final double D_RECOVER_MIN;
    public final double D_EFFORT_DEC_THR;
    public final double D_EFFORT_DEC;
    public final double D_EFFORT_INC_THR;
    ...
    public final double NUMERO_MAX_DE_CICLOS_PARA_INTERECEPTAR_BOLA;
    /**
    ...
    public ServerParams_Player() {
        ...
        CATCHABLE_AREA_W = Builder.CATCHABLE_AREA_W;
        CATCHABLE_AREA_L = Builder.CATCHABLE_AREA_L;
        D_RECOVER_DEC_THR = Builder.D_RECOVER_DEC_THR;
        D_RECOVER_MIN = Builder.D_RECOVER_MIN;
        D_RECOVER_DEC = Builder.D_RECOVER_DEC;
        D_EFFORT_DEC_THR = Builder.D_EFFORT_DEC_THR;
        D_EFFORT_DEC = Builder.D_EFFORT_DEC;
        D_EFFORT_INC = Builder.D_EFFORT_INC;
        D_EFFORT_INC_THR = Builder.D_EFFORT_INC_THR;
        D_EFFORT_MIN = Builder.D_EFFORT_MIN;
        KICK_POWER_RATE = Builder.KICK_POWER_RATE;
        PLAYER_WHEN_TO_KICK = Builder.PLAYER_WHEN_TO_KICK;
        TURN_MAX_MOMENT = Builder.TURN_MAX_MOMENT;
        TURN_MIN_MOMENT = Builder.TURN_MIN_MOMENT;
        DASH_POWER_RATE = Builder.DASH_POWER_RATE;
        NUMERO_MAX_DE_CICLOS_PARA_INTERECEPTAR_BOLA = Builder.NUMERO_MAX_DE_CICLOS_PARA_INTERECEPTAR_BOLA;
    }

    /**
     * @class Builder Default values for this parameter class are stored here.
     * The provided setters and parsing routines allow for safe modification
     * without affecting parameters that may already be in use. <br> <br>
    ...
    public static class Builder {
        ...
        private static double CATCHABLE_AREA_W = 1.0;
        private static double CATCHABLE_AREA_L = 2.0;
        private static double D_RECOVER_DEC_THR = 0.3;
        private static double D_RECOVER_DEC = 0.002;
        private static double D_RECOVER_MIN = 0.5;
        private static double D_EFFORT_DEC_THR = 0.3;
        private static double D_EFFORT_DEC = 0.005;
        private static double D_EFFORT_INC_THR = 0.6;
        private static double D_EFFORT_INC = 0.01;
        private static double D_EFFORT_MIN = 0.6;
        private static double KICK_POWER_RATE = 0.027;
        private static double PLAYER_WHEN_TO_KICK = 0.85;
        private static double TURN_MAX_MOMENT = 180;
        private static double TURN_MIN_MOMENT = -180;
        private static double DASH_POWER_RATE = 0.006;
        private static double NUMERO_MAX_DE_CICLOS_PARA_INTERECEPTAR_BOLA = 30;
         ...
         * Where Name is the name of a parameter as specified by the server, and
         * Value is the given value for that parameter. Used in parsing. <br>
         * <br>
