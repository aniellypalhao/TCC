...
public class Reta {
    ...
    public Point getIntersecao(Reta reta2){
        Point p = new Point();
        double x, y;
    ...
    public Point pontoNaRetaMaisProxDoPonto(Point p){
        Reta r2 = tangente(p);
        return this.getIntersecao(r2);
    }
    
    public static Reta criarRetaEntre2Pontos(Point p1, Point p2){
        double dA, dB, dC;
     ...
     */
    public static Reta criarRetaAPartirDaPosicaoEAngulo(Point p, double angulo){
        Point p2        = p;
