...
/**
 * @file Client.java Network agent that handles UDP communication with the game
 * server.
 *
...
public class Client {
        ...
        for (int i = 0; i < args.length; i++) {
            try {
                ...
                if (args[i].equals("--goalie")) {
                    ...
                    this.player.brain.role = PlayerRole.Role.GOLEIRO;
                }
    ...
    /**
     * Initalizes a client. Schedules and starts related threads and connects to
     * the server.
     */
    public void init() {
        try {
        ...
        if (this.player.brain.role != PlayerRole.Role.GOLEIRO) {
