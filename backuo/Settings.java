...
public class Settings {
    ...
    public static final double MARCACAO = 20;
    ...
    public static final String BALL_ID = "(b)";
    
    // Field geometry for a standard field
    public static double GOAL_HEIGHT                            = 14.02;
    public static double COMPRIMENTO_RETANGULO_DA_BOLA          = 5;
    public static double COMPRIMENTO_RETANGULO_ANTERIOR_DA_BOLA = 5;
    public static final double ALTURA_PEQUENA_AREA              = 16.0;
    public static final double COMPRIMENTO_PEQUENA_AREA         = 6.5;
    public static final double CATCHABLE_AREA_W                 = 1;
    public static final double CATCHABLE_AREA_L                 = 2;
    ...
    public static final double CONFIANCA_BOLA                   = 0.9;
    public static final double PENALTY_X                        = Settings.FIELD_WIDTH/2 - Settings.PENALTY_AREA_WIDTH;
    ...
    public static Rectangle CAMPO_L = new Rectangle(-FIELD_HEIGHT / 2.0, 0, FIELD_HEIGHT / 2.0, -FIELD_WIDTH / 2.0);
    public static Rectangle CAMPO_R = new Rectangle(-FIELD_HEIGHT / 2.0, FIELD_WIDTH / 2.0, FIELD_HEIGHT / 2.0, 0);
    
    
    public static Rectangle PEQUENA_AREA_L = new Rectangle(-ALTURA_PEQUENA_AREA / 2.0, -(FIELD_WIDTH / 2.0) + COMPRIMENTO_PEQUENA_AREA, ALTURA_PEQUENA_AREA / 2.0 ,-(FIELD_WIDTH / 2.0) + 1);
    public static Rectangle PEQUENA_AREA_R = new Rectangle(-ALTURA_PEQUENA_AREA / 2.0, (FIELD_WIDTH / 2.0) - 1 , ALTURA_PEQUENA_AREA / 2.0 ,(FIELD_WIDTH / 2.0) - COMPRIMENTO_PEQUENA_AREA);
    ...
    public static final PlayerRole.Role[] PLAYER_ROLES = {
        PlayerRole.Role.ATACANTE_DIREITO,
        PlayerRole.Role.ATACANTE_ESQUERDO,
        PlayerRole.Role.PONTA_DIREITA,
        PlayerRole.Role.MEIA_DIREITA,
        PlayerRole.Role.MEIA_ESQUERDA,
        PlayerRole.Role.PONTA_ESQUERDA,
        PlayerRole.Role.LATERAL_DIREITO,
        PlayerRole.Role.ZAGUEIRO_DIREITO,
        PlayerRole.Role.ZAGUEIRO_ESQUERDO,
        PlayerRole.Role.LATERAL_ESQUERDO,
        PlayerRole.Role.GOLEIRO            
    };
    ...
    public static final Point[] FORMATION = {
        ...
        new Point(-5.0, 0.0) ,  // Player 1 -20,-15
    	new Point(-10.0, -25.0),
    	new Point(-10.0, -15.0),
    	new Point(-10.0,  15.0),// -30.0 , 0.0
    	new Point(-10.0,  25.0),
    	new Point(-25.0, -10.0),
    	new Point(-25.0,  10.0),
    	new Point(-35.0, -20.0),
